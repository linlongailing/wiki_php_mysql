...
INSERT INTO `cmf_asset` VALUES (1,1,2622,1632722974,1,0,'550b35c35fa11ea052b40e482f29217d603e1e788293d64625d0f5deb858b75a','u37.png','default/20210927/9d81a7630bf5f0c7b81064ee019dc11d.png','550b35c35fa11ea052b40e482f29217d','240b6ebcd623bdc413b57d7ac53f326007e7d0de','png',NULL),(2,1,8793201,1632722991,1,0,'9ab92cc73e40e3def15bee7642fdf043599d43ee682ac85b20e805670b067946','b.mp4','default/20210927/5a5840834dd46a5bc17411362d8902b5.mp4','9ab92cc73e40e3def15bee7642fdf043','88c00a4b0e387cc336f3001256a4b76f6f3581b4','mp4',NULL),(3,1,3965,1632796333,1,0,'49bd1f0fc5ae7372466ecb6e3b12da1f5d77df3382eee88cde9694f05a569341','u36.png','default/20210928/e0ca3aa2dc61a381dd73dd3666e87a2f.png','49bd1f0fc5ae7372466ecb6e3b12da1f','e8b4b4fc18785fb763b09f05967ebd6bf4605cce','png',NULL),(4,1,22,1632796409,1,0,'76cdb2bad9582d23c1f6f4d868218d6c06d304531b5b2d4ac83e5e88c5f4722f','aa.zip','default/20210928/7561595dfb95ece58f0f7b9cf75be496.zip','76cdb2bad9582d23c1f6f4d868218d6c','b04f3ee8f5e43fa3b162981b50bb72fe1acabb33','zip',NULL);
...
INSERT INTO `cmf_user` VALUES (1,1,0,0,1632796244,0,0,0.00,1632711104,1,'admin','###59c7fe9a59e203bc31be630e59d0dc63','admin','zmllinlong@gmail.com','','','','183.14.133.222','','',NULL);
...
CREATE TABLE `cmf_user_action` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='用户操作表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cmf_user_token` VALUES (1,1,1648265777,1632713777,'170e98dbb02aa9e682674c270ca2c83711afcb38b034bc2d5c4a560bd55fb3d1','web');
...
--
-- Table structure for table `cmf_wiki`
--

DROP TABLE IF EXISTS `cmf_wiki`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cmf_wiki` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `class_id` int(11) NOT NULL DEFAULT '0' COMMENT '文章分类id，默认为0',
  `title` varchar(500) NOT NULL DEFAULT '' COMMENT '标题',
  `content` longtext NOT NULL COMMENT '内容',
  `time` int(11) NOT NULL COMMENT '时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='wiki文档';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cmf_wiki`
--

LOCK TABLES `cmf_wiki` WRITE;
/*!40000 ALTER TABLE `cmf_wiki` DISABLE KEYS */;
/*!40000 ALTER TABLE `cmf_wiki` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cmf_wiki_class`
--

DROP TABLE IF EXISTS `cmf_wiki_class`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cmf_wiki_class` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `parent_id` int(11) NOT NULL DEFAULT '0' COMMENT '父类id，默认为0',
  `title` varchar(200) NOT NULL COMMENT '标题',
  `time` int(11) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='wiki分类';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cmf_wiki_class`
--

LOCK TABLES `cmf_wiki_class` WRITE;
/*!40000 ALTER TABLE `cmf_wiki_class` DISABLE KEYS */;
INSERT INTO `cmf_wiki_class` VALUES (1,0,'php',1632721596),(2,0,'java',1632721646),(3,1,'php基础',1632721663),(4,2,'java高级教程',1632721677);
/*!40000 ALTER TABLE `cmf_wiki_class` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-09-28 10:46:15
